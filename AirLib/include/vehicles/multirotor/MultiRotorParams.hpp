...
namespace airlib
{
    ...
    public: //types
        ...
        struct Params
        {
            ...
            real_T arm_length = 0.690f / 2.0f; // arm length (= propeller spacing / 2) [m] - Weibin
        };
    ...
    protected: //static utility functions for derived classes to use
        ...
        void setupFrameGenericQuad(Params& params)
        {
            ...
            std::vector<real_T> arm_lengths(params.rotor_count, params.arm_length); // Default value: 0.2275f.
                                                                         // Here, I took 690mm as propeller spacing (i.e., 2 times of arm length) 
                                                                         // to be consistent with the empirical data used in Conyers's PhD dissertation.
